...
public class Lambda04 {/*
  /*
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println(ogrcSayisi1050BykEnBykMaxNotOrt(unv));
    }
    ...
    public static List<Universite> ogrSayisiBykSirala(List<Universite> unv) {
        return unv.//List <Integer> --> (1,2,3,4) List <Integer> -->(u01,u02,u03,u04,u05)
                stream().  // akış sağlandı
...
public static OptionalInt ogrcSayisi1050BykEnBykMaxNotOrt(List<Universite> unv){
